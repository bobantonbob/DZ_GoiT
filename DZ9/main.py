...
cluster_uri = "mongodb://localhost:27017/DZ8"
connect(host=cluster_uri)
...
def load_data_to_mongodb(file_path, model):
...
if __name__ == '__main__':
    ...
    # Завантаження даних з файлу quotes.json до колекції Quote
    load_data_to_mongodb('quotes.json', Quote)

    # Завантаження даних з файлу authors.json до колекції Author
    load_data_to_mongodb('authors.json', Author)
